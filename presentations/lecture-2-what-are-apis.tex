...
\begin{frame}{Anatomy of an API Call}
    ...
    \begin{tikzpicture}[
        ...
        \draw[brace, sgsssGreen] (0,-0.35) -- (3.55,-0.35)
            node[below=8pt, midway, label, text=sgsssGreen] {Base URL};
        \draw[brace, sgsssBlack] (3.55,-0.35) -- (6.35,-0.35)
            node[below=8pt, midway, label, text=sgsssBlack] {Endpoint};
        \draw[brace, sgsssMagenta] (6.35,-0.35) -- (12.65,-0.35)
    ...
    \begin{columns}[T]
        \begin{column}{0.48\textwidth}
            ...
            \begin{tikzpicture}[
                ...
                % Array box
                \node[box, draw=none, fill=sgsssMagenta!5, minimum width=5cm, minimum height=1.8cm] (arr) at (0.2,-0.6) {};
                ...
                \node[box, draw=none, fill=sgsssGreen!8, minimum width=4cm, minimum height=0.8cm] (nested) at (0.2,-0.6) {};
